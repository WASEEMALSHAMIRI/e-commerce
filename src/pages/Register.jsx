    ...
    return (
        <div>
            <Container className='mt-5 pt-5'>
                <h1 className='border  border-0 border-bottom-4 border-dark me-2 text-center'>Register</h1>
                <h1 className='border border-dark me-2'> </h1>
                <form className='mx-auto px-4' style={{ width: "70%" }}>
                    <Form className='text-start '>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                            <Form.Label >Full Name</Form.Label>
                            <Form.Control type="text" placeholder="Enter Name" className='border border-dark me-2' />
                        ...
                        <h5>Already has an account ?<a href="/Login">Login</a></h5>
